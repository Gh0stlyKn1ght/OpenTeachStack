...
Source registry: `src/lib/book.ts`

This folder is the course-owned content package for OTS-101. It is designed so the course can be migrated, exported, or maintained without hunting through global content folders.
