...
Use this prompt structure to avoid generic AI lesson output.

## When to use it

Use it when drafting student-facing lessons, assignment directions, examples, checks, or rubrics.
...
Never paste private student records, confidential policy, grades, or protected student work into the prompt.
