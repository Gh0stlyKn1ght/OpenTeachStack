...
Map the verification work before using AI output.

The teacher chooses what AI may help draft, what sources anchor the work, and what must be checked before students see it.
...
| Artifact work | Add a checklist section for source checks, privacy checks, bias checks, and teacher approval. |
