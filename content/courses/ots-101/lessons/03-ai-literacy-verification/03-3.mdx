...
Check sources before copying claims into lessons.

A generated paragraph includes a citation-looking phrase but no usable source link. The teacher replaces it with a source note from official documentation or removes the claim.
...
| Field | Your note |
| --- | --- |
| Lesson focus | Citation and Source Verification |
...
| Artifact work | Add a citation check that distinguishes provided sources from invented references. |
