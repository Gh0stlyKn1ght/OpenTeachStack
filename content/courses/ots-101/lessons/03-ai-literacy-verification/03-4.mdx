...
Inspect examples for stereotypes, narrow assumptions, and missing learners.

A project example only shows boys building robots and uses expensive home equipment. The teacher revises it toward classroom materials and broader student roles.
...
| Field | Your note |
| --- | --- |
| Lesson focus | Bias and Representation Checks |
...
| Artifact work | Add a representation check for names, roles, access, language, and examples. |
