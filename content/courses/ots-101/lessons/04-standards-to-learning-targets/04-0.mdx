...
Preview the path from standard text to classroom evidence.

The teacher starts with a standard, identifies what students must do, and chooses evidence that can actually be observed.
...
| Artifact work | Create columns for standard text, verb, concept, target, evidence, and lesson connection. |
