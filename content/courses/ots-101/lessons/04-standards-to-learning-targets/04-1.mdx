...
Avoid treating a standard as a complete lesson plan.

A standard may say students analyze data, but the lesson must still name the data set, student action, time, and product.
...
| Field | Your note |
| --- | --- |
| Lesson focus | Standards Are Not Lessons |
...
| Artifact work | Write one sentence explaining what the standard does not yet tell you. |
