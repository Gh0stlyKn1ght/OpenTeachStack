...
Separate what students do from what they use or know.

In 'analyze sensor data to justify a design decision,' analyze and justify are verbs; sensor data and design decision are nouns.
...
| Field | Your note |
| --- | --- |
| Lesson focus | Unpacking Verbs and Nouns |
...
| Artifact work | Highlight verbs and nouns in one selected standard. |
