...
Choose evidence that proves the target, not just activity completion.

A completed robot is not enough evidence if the target is justification; the teacher needs the data table and explanation too.
...
| Field | Your note |
| --- | --- |
| Lesson focus | Matching Evidence to Targets |
...
| Artifact work | Add evidence type, collection method, and review criterion. |
