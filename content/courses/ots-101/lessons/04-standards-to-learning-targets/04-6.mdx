...
Find activities that sound aligned but do not measure the target.

A vocabulary quiz about sensors does not prove students can use readings to justify a threshold.
...
| Field | Your note |
| --- | --- |
| Lesson focus | Avoiding Fake Alignment |
...
| Artifact work | Write one non-example and explain why it fails alignment. |
