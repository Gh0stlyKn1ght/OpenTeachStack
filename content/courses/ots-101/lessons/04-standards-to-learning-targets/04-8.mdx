...
Check whether the target and evidence match.

A colleague should be able to read the sheet and predict what students will do and submit.
...
| Artifact work | Mark each row ready, revise, or blocked. |
