...
Preview the structure of a usable mini-unit.

The teacher moves from one good activity to a short sequence where each lesson has a role.
...
| Artifact work | Sketch the unit question, lesson sequence, and final evidence. |
