...
Name the scale of the work before designing it.

The sensor threshold task is an activity; the lesson includes launch and reflection; the unit connects data, testing, and design decisions.
...
| Field | Your note |
| --- | --- |
| Lesson focus | Course vs Unit vs Lesson vs Activity |
...
| Artifact work | Sort three pieces of your curriculum by scale. |
