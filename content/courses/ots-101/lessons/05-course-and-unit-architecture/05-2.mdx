...
Use a question that gives the unit direction.

Instead of 'learn sensors,' the teacher asks, 'How much evidence should a robot use before acting?'
...
| Field | Your note |
| --- | --- |
| Lesson focus | Essential Questions |
...
| Artifact work | Draft one essential question and one student-friendly version. |
