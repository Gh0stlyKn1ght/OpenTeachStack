...
Put lessons in an order that builds understanding.

Students first observe readings, then test reliability, then choose thresholds, then explain a design choice.
...
| Artifact work | Map three to five lessons with purpose and evidence. |
