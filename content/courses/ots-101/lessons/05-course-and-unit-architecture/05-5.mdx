...
Place small checks before the final product.

Before the final reflection, students identify the most unreliable reading and explain why it may be wrong.
...
| Field | Your note |
| --- | --- |
| Lesson focus | Checks for Understanding |
...
| Artifact work | Add one quick check and what the teacher does with the result. |
