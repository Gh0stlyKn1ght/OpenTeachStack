...
Connect targets, lessons, resources, and evidence in one view.

The map shows which lesson introduces data, which lesson tests it, and which artifact proves learning.
...
| Field | Your note |
| --- | --- |
| Lesson focus | Mini-Unit Mapping |
...
| Artifact work | Fill in the map with lesson title, target, resource, evidence, and revision note. |
