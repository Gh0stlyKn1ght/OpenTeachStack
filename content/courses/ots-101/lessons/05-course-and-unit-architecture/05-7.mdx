...
Build the smallest coherent unit worth teaching.

The finished mini-unit has enough structure for another teacher to run it without guessing the sequence.
...
Build the **Mini-unit map and lesson template** so another educator can inspect the decision, not just the finished material.

Add this entry:

| Field | Your note |
| --- | --- |
| Lesson focus | 3-5 Lesson Mini-Unit |
...
| Artifact work | Create the 3-5 lesson packet or map. |
