...
Handle media as instructional evidence, not decoration.

A short video is useful only if it teaches the concept, has accessible captions, and does not replace teacher explanation.
...
| Field | Your note |
| --- | --- |
| Lesson focus | YouTube, Images, and Attribution |
...
| Artifact work | Add media purpose, caption/accessibility, and attribution notes. |
