...
Judge whether a resource deserves classroom trust.

The teacher checks author, date, evidence, reading level, ads, and whether claims match official guidance.
...
| Field | Your note |
| --- | --- |
| Lesson focus | Evaluating Source Quality |
...
| Artifact work | Score one resource as use, revise context, or reject. |
