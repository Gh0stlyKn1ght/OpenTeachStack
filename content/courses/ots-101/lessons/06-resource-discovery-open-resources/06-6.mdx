...
Organize reusable sources so future lessons can cite them quickly.

The source bank stores link, purpose, license, lesson connection, and last checked date.
...
| Field | Your note |
| --- | --- |
| Lesson focus | Building a Source Bank |
...
| Artifact work | Add three sources with lesson connections. |
