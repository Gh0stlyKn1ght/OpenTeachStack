...
Preview how Workspace tools support the mini-unit system.

The teacher chooses what each tool does instead of dropping every file into one folder.
...
| Artifact work | Create a workspace map with folder, file type, purpose, owner, and update routine. |
