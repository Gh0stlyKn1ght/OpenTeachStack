...
Design folders around work roles.

The teacher creates folders for source notes, teacher prep, student-facing materials, assessment evidence, and archive.
...
| Field | Your note |
| --- | --- |
| Lesson focus | Folder Architecture |
...
| Artifact work | Map your unit folder structure. |
