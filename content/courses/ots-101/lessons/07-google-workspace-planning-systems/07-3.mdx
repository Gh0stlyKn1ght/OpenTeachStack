...
Use Docs for reusable directions and teacher notes.

A direction template includes launch, materials, steps, submit section, accessibility note, and revision log.
...
| Field | Your note |
| --- | --- |
| Lesson focus | Docs as Lesson Templates |
...
| Artifact work | Create or outline one lesson Doc template. |
