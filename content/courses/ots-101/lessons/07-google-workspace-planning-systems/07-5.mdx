...
Use Forms when the response data needs sorting or review.

A three-question exit ticket sends misconception data to the tracker before the next lesson.
...
| Field | Your note |
| --- | --- |
| Lesson focus | Forms as Checks for Understanding |
...
| Artifact work | Draft one form check and response-use note. |
