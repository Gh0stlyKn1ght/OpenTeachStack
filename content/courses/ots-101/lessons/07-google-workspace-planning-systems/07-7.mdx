...
Build the map that shows how the tools connect.

The map tells another teacher where to find materials and what each file does.
...
| Field | Your note |
| --- | --- |
| Lesson focus | Workspace Planning Map |
...
| Artifact work | Complete the workspace planning map for one mini-unit. |
