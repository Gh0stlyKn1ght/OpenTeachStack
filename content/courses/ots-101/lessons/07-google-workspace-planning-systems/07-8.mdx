...
Check whether the workspace can survive real classroom use.

If a colleague cannot find the current directions and evidence tracker in two minutes, revise the structure.
...
| Artifact work | Mark each file or folder ready, revise, archive, or private. |
