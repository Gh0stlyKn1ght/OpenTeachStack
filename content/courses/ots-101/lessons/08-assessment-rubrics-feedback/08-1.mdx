...
Separate doing the task from proving the target.

Building a robot is an activity; explaining a threshold with data is evidence of the target.
...
| Field | Your note |
| --- | --- |
| Lesson focus | Activities Are Not Always Assessments |
...
| Artifact work | Label one activity and the evidence it produces. |
