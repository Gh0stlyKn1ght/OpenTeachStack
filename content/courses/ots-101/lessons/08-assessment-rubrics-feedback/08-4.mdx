...
Write criteria that can be seen in student work.

Instead of 'understands sensors,' use 'uses at least three readings to justify the threshold.'
...
| Field | Your note |
| --- | --- |
| Lesson focus | Rubrics With Observable Criteria |
...
| Artifact work | Draft three observable rubric criteria. |
