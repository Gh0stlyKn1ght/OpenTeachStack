...
Build revision into the assessment design.

Students revise the threshold claim after comparing their data with a peer group.
...
| Field | Your note |
| --- | --- |
| Lesson focus | Revision Opportunities |
...
| Artifact work | Add one revision moment before final submission. |
