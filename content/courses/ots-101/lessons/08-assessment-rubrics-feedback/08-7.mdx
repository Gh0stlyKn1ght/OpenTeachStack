...
Build the artifact that connects target, evidence, criteria, and feedback.

The draft includes the student product, rubric criteria, formative check, and revision path.
...
Build the **Assessment and rubric draft** so another educator can inspect the decision, not just the finished material.

Add this entry:

| Field | Your note |
| --- | --- |
| Lesson focus | Assessment + Rubric Draft |
...
| Artifact work | Complete the assessment and rubric draft for one mini-unit task. |
