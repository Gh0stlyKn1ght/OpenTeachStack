...
Check whether the assessment measures the target.

If the rubric rewards neatness more than evidence use, revise it.
...
| Artifact work | Mark each criterion keep, revise, remove, or add evidence. |
