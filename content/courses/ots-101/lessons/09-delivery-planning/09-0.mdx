...
Preview the delivery decisions that make a lesson usable.

The teacher checks what students see, when they see it, what to do when technology fails, and what evidence gets collected.
...
| Artifact work | Create fields for launch, materials, timing, directions, media, backup, and close. |
