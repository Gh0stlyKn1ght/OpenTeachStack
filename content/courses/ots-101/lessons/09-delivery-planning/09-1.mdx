...
Recognize that strong content can fail if classroom flow is unclear.

A well-aligned sensor activity still needs materials ready, groups assigned, directions visible, and collection steps timed.
...
| Field | Your note |
| --- | --- |
| Lesson focus | A Good Lesson Still Needs Delivery |
...
| Artifact work | Add one delivery risk and prevention step. |
