...
Write directions students can act on without decoding teacher notes.

Directions say what to get, what to do first, what to record, what to submit, and when to ask for help.
...
| Artifact work | Revise one direction into numbered student-facing steps. |
