...
Preview the final assembly process.

The teacher gathers the workflow audit, prompt library, verification checklist, standards sheet, unit map, resource sheet, assessment draft, and delivery plan.
...
| Artifact work | Create a capstone index with artifact links and status. |
