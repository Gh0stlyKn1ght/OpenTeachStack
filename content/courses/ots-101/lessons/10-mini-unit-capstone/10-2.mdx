...
Check that the capstone claims are backed by sources and standards.

The teacher confirms each lesson target connects to the standards sheet and each borrowed resource appears in the resource sheet.
...
| Field | Your note |
| --- | --- |
| Lesson focus | Verify Standards and Sources |
...
| Artifact work | Add a verification row for standards and sources. |
