...
Use another educator to find unclear decisions.

The reviewer checks whether they can understand the mini-unit purpose, student task, evidence, and delivery flow.
...
| Artifact work | Record reviewer question, issue, and response. |
