...
Explain the unit as a teachable system.

The teacher presents the learning target, student evidence, source choices, assessment, and delivery plan in plain language.
...
| Field | Your note |
| --- | --- |
| Lesson focus | Present the Mini-Unit |
...
| Artifact work | Draft a short presentation outline. |
