...
Reflect on what became more inspectable.

The teacher identifies which part of the workflow moved from memory into a reusable artifact.
...
| Artifact work | Write a reflection on the strongest artifact and next improvement. |
