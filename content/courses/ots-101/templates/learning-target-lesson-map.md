...
Use this to move from a standard, goal, or messy idea into student-facing lesson content.

## When to use it

Use it before prompting AI for a lesson draft.
...
Do not let AI invent safety steps. Provide the approved sequence or mark it for human verification.
