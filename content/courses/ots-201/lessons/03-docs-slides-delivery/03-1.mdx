...
Use Docs for directions students and teachers can return to.

A reusable lesson Doc makes the student task, materials, links, submission evidence, and teacher setup notes easy to inspect.
...
Build the **Reusable Docs/Slides template set** so the workspace decision can be inspected and reused.

Add or revise this entry:

| Field | Your note |
| --- | --- |
| Lesson focus | Docs as Directions and Lesson Templates |
...
| Artifact work | Draft the Doc template headings and mark which sections are student-facing and which are teacher-only. |
