...
Make templates readable, navigable, and usable for students.

Student-facing language should tell learners what to do, what to submit, where to find help, and how success will be judged without requiring teacher translation.
...
| Field | Your note |
| --- | --- |
| Lesson focus | Accessibility and Student-Facing Language |
...
| Artifact work | Revise one direction for plain language, link clarity, headings, alt text needs, and reading load. |
