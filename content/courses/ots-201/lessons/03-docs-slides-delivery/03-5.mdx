...
Check whether the template set supports real classroom delivery.

The test is whether a future lesson can be created from the template without leaving missing directions, broken links, unlabeled evidence, or inaccessible media.
...
| Artifact work | Run the template against one upcoming lesson and mark each section keep, revise, add, or remove. |
