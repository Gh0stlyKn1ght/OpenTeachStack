...
Connect standards to lessons without creating fake alignment.

The tracker should show why a lesson belongs to a standard and what evidence proves the target, not simply paste a standard code beside every activity.
...
| Field | Your note |
| --- | --- |
| Lesson focus | Tracking Standards and Lessons |
...
| Artifact work | Add standard code, target, evidence, and alignment note fields for three lessons. |
