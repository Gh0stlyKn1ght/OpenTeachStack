...
Keep resource choices and evidence locations visible.

When a resource, assessment, or student evidence folder changes, the tracker should reveal the impact on the lesson sequence.
...
| Field | Your note |
| --- | --- |
| Lesson focus | Tracking Resources and Assessment Evidence |
...
| Artifact work | Add resource link, license or source note, evidence location, and review date to one tracker section. |
