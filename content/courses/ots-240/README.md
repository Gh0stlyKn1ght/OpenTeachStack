...
Canonical route: `/book/ots-240`

This folder is the course-owned content package for OTS-240. It is designed so the course can be migrated, exported, or maintained without hunting through global content folders.
