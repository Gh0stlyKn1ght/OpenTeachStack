...
This outline is backed by course-owned AI coding agent and workflow material:
...
| 05. Building Teacher Tools | Build a small self-contained tool, script, or page that solves a real classroom workflow. | OTS-220 labs, `how-i-built-one-day-lesson-sites.mdx` | Small classroom tool |
| 06. Reviewed Agent Build | Package prompts, diffs, tests, revisions, and teacher approval evidence. | OTS-320 course lessons and templates | Reviewed agent-built classroom tool |
