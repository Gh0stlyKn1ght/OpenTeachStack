...
Capstone Scope emphasizes **choosing one teaching need and publishable outcome that can be evidenced in one cycle.**. In this section, **Chapter Overview** applies that intent to one concrete teacher-owned action with visibility for peers and future maintenance.
