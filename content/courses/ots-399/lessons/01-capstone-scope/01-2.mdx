...
Capstone Scope emphasizes **choosing one teaching need and publishable outcome that can be evidenced in one cycle.**. This lesson turns **Pathway Evidence Requirements** into a capstone evidence item that peers can inspect and maintain later.
