...
- **Role** — "You are a curriculum writer for a high school computer science course."
- **Context** — "This lesson is for 10th graders who have never written code."
- **Specific task** — "Write 5 multiple-choice questions about DNS, each with 4 options."
- **Constraints** — "Use simple language. Avoid jargon. Each question should test understanding, not recall."
- **Format** — "Return the questions in a table with columns: Question, A, B, C, D, Correct Answer."
...
- Write a detailed prompt with role, context, task, constraints, and format
- Review every question for accuracy
- Identify at least one error or improvement needed
- Revise the output and format it for your question bank spreadsheet
