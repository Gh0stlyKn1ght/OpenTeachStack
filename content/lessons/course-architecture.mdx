...
Lesson Flow:
- Opening (5 min): _______________
- Direct Instruction (15 min): _______________
- Guided Practice (15 min): _______________
- Independent Practice (15 min): _______________
- Closure / Exit Ticket (5 min): _______________
...
- Write one essential question for the unit
- List 3-5 learning objectives using measurable verbs
- Outline 4-6 lessons with the direct instruction / guided practice / independent practice structure
- Choose one formative and one summative assessment
- Fill in the lesson template for the first lesson of the unit
