...
1. Draw the tree structure (root → year → units → subfolders)
2. Write your naming convention rules
3. Identify 3-5 templates you would put in your `_Templates` folder
