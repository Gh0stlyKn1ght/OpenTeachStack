...
- Under **Quizzes**, toggle **"Make this a quiz"**
- Configure:
...
- Set the **point value**
- Optionally add **answer feedback** for correct and incorrect responses
...
- Enable quiz mode
- Write 5 multiple-choice questions about a topic you teach
- Set correct answers, point values, and answer feedback for each
- Take the quiz yourself to verify auto-grading works
- Review the Responses tab and identify which views are most useful
