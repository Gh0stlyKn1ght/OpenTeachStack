...
- **Row 1 is headers.** Always. No merged cells. No decorative rows above the data.
- **One row = one record.** Each row is a lesson, a resource, a question — one thing.
- **Consistent data types.** A column should contain only one type: text, number, date, or URL.
- **Use data validation.** Dropdowns for status fields, difficulty levels, content types.
- **No blank rows in the middle.** Scripts break on gaps.

### Example: Lessons Tab

| Unit | Lesson | Type | Duration | Level | Status | Link |
|------|--------|------|----------|-------|--------|------|
| Foundations | What Teaching Teachers Is | Lecture | 30 min | Beginner | Complete | [link] |
...
- Give it a clear name: `LessonsData`, `QuestionBankData`
...
- Create a "Lessons" tab with columns: Unit, Lesson, Type, Duration, Level, Status, Link
- Add 5 rows of data from a course you teach
- Add data validation for the Status column: Draft, In Progress, Complete
- Add data validation for the Type column: Lecture, Lab, Assessment, Activity
