...
duration: "30 minutes"
level: "Beginner"
summary: "Open TeachStack is a pathway for building curriculum systems — not a tool list or an everything-at-once course."
outcomes:
  - Define Open TeachStack and its purpose.
...
Open TeachStack is not a list of apps. It is not a recommendation engine. It is not a startup pitch about "transforming education."
...
Open TeachStack treats your curriculum like a system to be designed, built, documented, and maintained.
...
```mermaid
flowchart TD
    A[Open TeachStack Foundations] --> B[Plan]
    A --> C[Verify]
    A --> D[Deliver]
...
1. **Plan** — Turn standards and teaching goals into a coherent mini-unit.
2. **Verify** — Check AI output, resources, alignment, accessibility, and copyright.
3. **Deliver** — Prepare directions, assessment, feedback, and revision routines.
