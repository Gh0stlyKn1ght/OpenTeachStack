---
title: "What Teaching Teachers Is"
...
duration: "30 minutes"
level: "Beginner"
summary: "Teaching Teachers is a pathway for building curriculum systems — not a tool list or an everything-at-once course."
outcomes:
  - Define Teaching Teachers and its purpose.
...
Teaching Teachers is not a list of apps. It is not a recommendation engine. It is not a startup pitch about "transforming education."
...
Teaching Teachers treats your curriculum like a system to be designed, built, documented, and maintained.
...
```mermaid
flowchart TD
    A[Teaching Teachers Foundations] --> B[Plan]
    A --> C[Verify]
    A --> D[Deliver]
