...
const forbiddenVisibleText = [
  ...
  /sourceLessonTitle/i,
  /generated draft/i,
  /This page turns that pressure into a visible update/i,
  /Make this page concrete by writing three small decisions/i,
  /\bchapter plan Why This Matters\b/,
  /\bcheckpoint review Why This Matters\b/,
  /scaffolded/i,
  /authoring status/i,
