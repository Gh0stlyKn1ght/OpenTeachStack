...
export function generateStaticParams() {
  return getPublishedBlogPosts("author-blog").map((post) => ({ slug: post.slug }));
}
...
export async function generateMetadata({
  ...
  const post = getPublishedBlogPost(slug, "author-blog");

  if (!post) {
    return { title: "Blog Post Not Found — OpenTeachStack" };
  }

  return {
    title: `${post.title} — JC's Blog`,
