...
export default async function Ots220BookPage() {
  const course = getCourseStructure(COURSE_SLUG);
  ...
  return (
    <CourseStructureBookShell
      ...
      notes={[
        ...
        { label: "Course", value: course.code, href: "/book/ots-220" },
    ...
    >
      ...
      <section className="book-spread">
        <div>
          ...
          <p>{course.thesis}</p>
          <p>
            OTS-220 focuses on small, reviewable, and reversible automation that
            supports daily teaching operations.
          </p>
        </div>
        <ArtifactCard
