...
export default async function Ots240BookPage() {
  const course = getCourseStructure(COURSE_SLUG);
  ...
  return (
    <CourseStructureBookShell
      ...
      notes={[
        ...
        { label: "Course", value: course.code, href: "/book/ots-240" },
    ...
    >
      ...
      <section className="book-spread">
        <div>
          ...
          <p>{course.thesis}</p>
          <p>
            OTS-240 focuses on open, versioned curriculum practices that are safe
            to reuse and easy to review with another educator.
          </p>
        </div>
        <ArtifactCard
          title={course.finalArtifact}
          description={`Finish when teachers can publish and maintain an open curriculum repository with attribution and review notes.`}
        />
      </section>
