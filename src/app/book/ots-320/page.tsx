...
export default async function Ots320BookPage() {
  const course = getCourseStructure(COURSE_SLUG);
  ...
  return (
    <CourseStructureBookShell
      ...
      notes={[
        ...
        { label: "Course", value: course.code, href: "/book/ots-320" },
    ...
    >
      ...
      <section className="book-spread">
        <div>
          ...
          <p>{course.thesis}</p>
          <p>
            OTS-320 focuses on coding-agent-assisted teaching workflows, using prompts, diffs,
            tests, and review habits before any classroom-facing change is accepted.
          </p>
        </div>
        <ArtifactCard
