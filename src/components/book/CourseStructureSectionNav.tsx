...
import type { CourseSectionRecord } from "@/lib/courseStructures";

interface CourseStructureSectionNavProps {
  previous?: CourseSectionRecord;
  next?: CourseSectionRecord;
}

export default function CourseStructureSectionNav({
  previous,
  next,
}: CourseStructureSectionNavProps) {
  return (
    <nav
