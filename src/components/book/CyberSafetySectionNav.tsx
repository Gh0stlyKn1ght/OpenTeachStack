...
import type { CyberSectionRecord } from "@/lib/cyberSafety";

interface CyberSafetySectionNavProps {
  previous?: CyberSectionRecord;
  next?: CyberSectionRecord;
}

export default function CyberSafetySectionNav({ previous, next }: CyberSafetySectionNavProps) {
  return (
    <nav
