...
export const COURSE_STRUCTURES: CourseStructure[] = [
  {
    ...
    thesis:
      "Help teachers understand the software, vocabulary, documentation, and safety habits behind AI-supported curriculum projects before they touch advanced course sites or coding agents.",
    finalArtifact: "Builder workspace setup plan",
    chapters: [
      chapter("01", "The Builder Workstation", "builder-workstation", "Teachers can get stuck before the course begins when they do not know what kind of computer, browser, accounts, or local tools the work requires.", "What does a teacher-builder need installed, connected, and understood before project work starts?", "Builder workstation checklist", ["tool setup", "system requirements"], [
        section("01.0", "Chapter Overview", "overview", "10 minutes"),
        section("01.1", "Browser Tools vs Local Tools"),
        section("01.2", "PC, Mac, Chromebook, RAM, Storage, and WSL"),
        section("01.3", "Accounts, Downloads, and Update Habits"),
        section("01.4", "Build Task: Workstation Checklist", "artifact", "35 minutes", "Builder workstation checklist"),
        section("01.5", "Chapter Checkpoint", "checkpoint", "10 minutes"),
      ]),
      chapter("02", "Files, Folders, Paths, and Projects", "files-folders-paths-projects", "Modern curriculum projects break down when teachers cannot tell the difference between a file, folder, route, project, export, and source of truth.", "How do files and folders become a project a teacher can navigate?", "Project structure map", ["file literacy", "project navigation"], [
        section("02.0", "Chapter Overview", "overview", "10 minutes"),
        section("02.1", "Files, Folders, Paths, and Extensions"),
        section("02.2", "Projects, Workspaces, and Source of Truth"),
        section("02.3", "Markdown, MDX, JSON, and Config Files"),
        section("02.4", "Build Task: Project Structure Map", "artifact", "35 minutes", "Project structure map"),
        section("02.5", "Chapter Checkpoint", "checkpoint", "10 minutes"),
      ]),
      chapter("03", "What Is an IDE?", "what-is-an-ide", "Teachers hear IDE, editor, terminal, source control, and extension before anyone explains what those words do in real work.", "How does an IDE help a teacher inspect and change a project safely?", "IDE navigation notes", ["IDE literacy", "VS Code basics"], [
        section("03.0", "Chapter Overview", "overview", "10 minutes"),
        section("03.1", "IDE vs Text Editor vs Browser Tool"),
        section("03.2", "VS Code Explorer, Search, Terminal, and Source Control"),
        section("03.3", "Extensions, Settings, and Workspace Trust"),
        section("03.4", "Build Task: IDE Navigation Notes", "artifact", "35 minutes", "IDE navigation notes"),
        section("03.5", "Chapter Checkpoint", "checkpoint", "10 minutes"),
      ]),
      chapter("04", "Terminal, Git, and GitHub Without the Panic", "terminal-git-github", "Teachers need enough command-line and version-control vocabulary to follow project work without feeling like every command is a trap.", "What terminal and Git habits make project work safer?", "Git safety notes", ["terminal basics", "version control"], [
        section("04.0", "Chapter Overview", "overview", "10 minutes"),
        section("04.1", "Terminal Basics and Safe Navigation"),
        section("04.2", "Git vs GitHub"),
        section("04.3", "Clone, Commit, Branch, Diff, and Pull Request"),
        section("04.4", "Build Task: Git Safety Notes", "artifact", "40 minutes", "Git safety notes"),
        section("04.5", "Chapter Checkpoint", "checkpoint", "10 minutes"),
      ]),
      chapter("05", "Documentation and Tool Literacy", "documentation-tool-literacy", "Tool docs can be accurate and still overwhelming if teachers do not know how to find setup pages, examples, warnings, and version notes.", "How do teachers read official software documentation without getting lost?", "Documentation reading checklist", ["documentation", "tool evaluation"], [
        section("05.0", "Chapter Overview", "overview", "10 minutes"),
        section("05.1", "Install Pages, Quickstarts, API Docs, and Guides"),
        section("05.2", "Version Numbers, Deprecations, and Breaking Changes"),
        section("05.3", "Official Docs vs Tutorials vs AI Summaries"),
        section("05.4", "Build Task: Documentation Reading Checklist", "artifact", "35 minutes", "Documentation reading checklist"),
        section("05.5", "Chapter Checkpoint", "checkpoint", "10 minutes"),
      ]),
      chapter("06", "Website and Project Stack Literacy", "website-project-stack-literacy", "Teachers opening a curriculum project need plain-language orientation to Node, npm, React, Next.js, TypeScript, Tailwind, MDX, hosting, and deployment.", "What are the pieces of a modern teacher-owned web project?", "Project stack vocabulary map", ["web literacy", "stack vocabulary"], [
        section("06.0", "Chapter Overview", "overview", "10 minutes"),
        section("06.1", "Node, npm, Packages, and Scripts"),
        section("06.2", "React, Next.js, TypeScript, Tailwind, Markdown, and MDX"),
        section("06.3", "Hosting, Domains, DNS, and Deployment"),
        section("06.4", "Build Task: Stack Vocabulary Map", "artifact", "40 minutes", "Project stack vocabulary map"),
        section("06.5", "Chapter Checkpoint", "checkpoint", "10 minutes"),
      ]),
      chapter("07", "AI Assistants, Coding Agents, and MCP", "ai-assistants-coding-agents-mcp", "Teachers need to know the difference between a chatbot, an IDE assistant, a terminal agent, and an MCP-connected tool before granting access to a project.", "What can AI tools access, change, and verify?", "AI tool comparison map", ["AI agents", "MCP basics"], [
        section("07.0", "Chapter Overview", "overview", "10 minutes"),
        section("07.1", "Chatbots, IDE Assistants, and Terminal Agents"),
        section("07.2", "Codex, Claude Code, Gemini, Copilot, Cursor, and Similar Tools"),
        section("07.3", "MCP as Tool Access, Not Magic"),
        section("07.4", "Build Task: AI Tool Comparison Map", "artifact", "40 minutes", "AI tool comparison map"),
        section("07.5", "Chapter Checkpoint", "checkpoint", "10 minutes"),
      ]),
      chapter("08", "Software Safety and Workspace Capstone", "software-safety-workspace-capstone", "The beginner stack is not complete until teachers know how to protect secrets, inspect diffs, keep backups, and decide what tools are allowed to touch.", "Can a teacher set up a safe builder workspace and explain what each tool is allowed to do?", "Builder workspace setup plan", ["safety", "verification"], [
        section("08.0", "Chapter Overview", "overview", "10 minutes"),
        section("08.1", "Permissions, Secrets, Sandboxes, and Backups"),
        section("08.2", "Reading Diffs and Knowing When to Stop"),
        section("08.3", "Tool Links, Docs, and Maintenance Notes"),
        section("08.4", "Final Build: Builder Workspace Setup Plan", "studio", "60 minutes", "Builder workspace setup plan"),
