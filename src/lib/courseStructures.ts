...
export const COURSE_STRUCTURES: CourseStructure[] = [
  {
    ...
    thesis:
      "Give teachers a plain-language on-ramp to the software, vocabulary, files, workflows, AI tools, and safety habits behind modern curriculum projects before they enter the deeper OpenTeachStack pathway.",
    finalArtifact: "Teacher Builder Starter Kit",
    chapters: [
      chapter("00", "Welcome to the Teacher Builder Stack", "welcome-teacher-builder-stack", "Teachers should not have to become software engineers before they understand the tools shaping modern curriculum work.", "What is the teacher builder stack, and why does OpenTeachStack start here?", "Teacher builder vocabulary map", ["orientation", "tool literacy"], [
        section("00.0", "Chapter Overview", "overview", "10 minutes"),
        section("00.1", "What Is the Teacher Builder Stack?"),
        section("00.2", "Why Educators Need Tool Literacy"),
        section("00.3", "Courses, Websites, Apps, and Knowledge Bases"),
        section("00.4", "Build Task: Teacher Builder Vocabulary Map", "artifact", "30 minutes", "Teacher builder vocabulary map"),
        section("00.5", "Chapter Checkpoint", "checkpoint", "10 minutes"),
      ]),
      chapter("01", "Your Computer as a Builder Workstation", "builder-workstation", "Teachers can get stuck before the course begins when they do not know what kind of computer, browser, accounts, or local tools the work requires.", "What does a teacher-builder need installed, connected, and understood before project work starts?", "Builder workstation checklist", ["tool setup", "system requirements"], [
        section("01.0", "Chapter Overview", "overview", "10 minutes"),
        section("01.1", "Chromebook, Windows, macOS, and Linux"),
        section("01.2", "CPU, RAM, Storage, GPU, and WSL in Plain English"),
        section("01.3", "Browser Tools vs Local Tools"),
        section("01.4", "Build Task: Builder Workstation Checklist", "artifact", "35 minutes", "Builder workstation checklist"),
        section("01.5", "Chapter Checkpoint", "checkpoint", "10 minutes"),
      ]),
      chapter("02", "Files, Folders, and Project Structure", "files-folders-project-structure", "Before GitHub, VS Code, or AI agents make sense, teachers need to understand files, folders, paths, extensions, and project structure.", "How do files and folders become a curriculum project a teacher can navigate?", "Labeled project-folder map", ["file literacy", "project navigation"], [
        section("02.0", "Chapter Overview", "overview", "10 minutes"),
        section("02.1", "Files, Folders, Paths, and Extensions"),
        section("02.2", "What Is a Project Folder?"),
        section("02.3", "Common Project Files: README, package.json, Markdown, and Config"),
        section("02.4", "Build Task: Labeled Project-Folder Map", "artifact", "35 minutes", "Labeled project-folder map"),
        section("02.5", "Chapter Checkpoint", "checkpoint", "10 minutes"),
      ]),
      chapter("03", "What Is an IDE?", "what-is-an-ide", "Teachers hear IDE, editor, terminal, source control, syntax highlighting, and extension before anyone explains what those words do in real work.", "How does an IDE help a teacher inspect and change a project safely?", "IDE navigation diagram", ["IDE literacy", "editor basics"], [
        section("03.0", "Chapter Overview", "overview", "10 minutes"),
        section("03.1", "IDE vs Text Editor vs Browser Editor"),
        section("03.2", "Explorer, Tabs, Search, Terminal, and Source Control"),
        section("03.3", "Syntax Highlighting and Extensions"),
        section("03.4", "Build Task: IDE Navigation Diagram", "artifact", "30 minutes", "IDE navigation diagram"),
        section("03.5", "Chapter Checkpoint", "checkpoint", "10 minutes"),
      ]),
      chapter("04", "VS Code for Teacher Builders", "vscode-teacher-builders", "VS Code becomes less intimidating when teachers learn the few areas they actually need for curriculum work.", "How can teachers open, search, edit, preview, and navigate project files in VS Code without getting lost?", "VS Code survival sheet", ["VS Code", "workspace navigation"], [
        section("04.0", "Chapter Overview", "overview", "10 minutes"),
        section("04.1", "Installing VS Code and Opening a Folder"),
        section("04.2", "Editing Markdown and MDX Files"),
        section("04.3", "Search, Preview, Terminal, and Beginner Extensions"),
        section("04.4", "Build Task: VS Code Survival Sheet", "artifact", "35 minutes", "VS Code survival sheet"),
        section("04.5", "Chapter Checkpoint", "checkpoint", "10 minutes"),
      ]),
      chapter("05", "The Terminal Without Fear", "terminal-without-fear", "Teachers need enough command-line confidence to follow project instructions without feeling like every command is a trap.", "What terminal habits let teachers move around, run project commands, and read errors calmly?", "Terminal command cheat sheet", ["terminal basics", "command literacy"], [
        section("05.0", "Chapter Overview", "overview", "10 minutes"),
        section("05.1", "What Is a Terminal?"),
        section("05.2", "Commands, Prompts, and Current Folders"),
        section("05.3", "cd, ls, pwd, mkdir, and Project Commands"),
        section("05.4", "Build Task: Terminal Command Cheat Sheet", "artifact", "30 minutes", "Terminal command cheat sheet"),
        section("05.5", "Chapter Checkpoint", "checkpoint", "10 minutes"),
      ]),
      chapter("06", "Git and GitHub Basics", "git-github-basics", "Version control protects teacher work, but Git and GitHub feel like coding jargon until the basic objects are named.", "How do repositories, commits, branches, pull requests, and READMEs protect curriculum projects?", "GitHub project-reading checklist", ["GitHub", "version control"], [
        section("06.0", "Chapter Overview", "overview", "10 minutes"),
        section("06.1", "Git vs GitHub"),
        section("06.2", "Repositories, READMEs, Commits, and History"),
        section("06.3", "Branches, Pull Requests, and Why Agents Need Git Safety"),
        section("06.4", "Build Task: GitHub Project-Reading Checklist", "artifact", "35 minutes", "GitHub project-reading checklist"),
        section("06.5", "Chapter Checkpoint", "checkpoint", "10 minutes"),
      ]),
      chapter("07", "Documentation Literacy", "documentation-literacy", "Official docs can be accurate and still overwhelming when teachers do not know what kind of page they are reading.", "How do teachers find reliable software guidance without reading every page or trusting random summaries?", "Documentation evaluation checklist", ["documentation", "source evaluation"], [
        section("07.0", "Chapter Overview", "overview", "10 minutes"),
        section("07.1", "Official Docs, Tutorials, Blog Posts, and AI Summaries"),
        section("07.2", "Install Guides, Quickstarts, Examples, and Troubleshooting"),
        section("07.3", "Version Numbers, Changelogs, and Current Links"),
        section("07.4", "Build Task: Documentation Evaluation Checklist", "artifact", "35 minutes", "Documentation evaluation checklist"),
        section("07.5", "Chapter Checkpoint", "checkpoint", "10 minutes"),
      ]),
      chapter("08", "Markdown, MDX, and Content Files", "markdown-mdx-content-files", "Teachers can edit curriculum projects more safely when they understand the content files that drive many course sites.", "How do Markdown and MDX turn teacher writing into structured course content?", "Starter Markdown lesson", ["Markdown", "MDX"], [
        section("08.0", "Chapter Overview", "overview", "10 minutes"),
        section("08.1", "What Is Markdown?"),
        section("08.2", "Headings, Links, Images, Tables, and Code Blocks"),
        section("08.3", "Frontmatter and MDX Components"),
        section("08.4", "Build Task: Starter Markdown Lesson", "artifact", "40 minutes", "Starter Markdown lesson"),
        section("08.5", "Chapter Checkpoint", "checkpoint", "10 minutes"),
      ]),
      chapter("09", "Websites, Hosting, and Publishing", "websites-hosting-publishing", "Teachers need a plain-language map of how local content becomes a public or classroom-facing website.", "What changes when a project moves from local preview to a published site?", "Website publishing flow diagram", ["web publishing", "hosting"], [
        section("09.0", "Chapter Overview", "overview", "10 minutes"),
        section("09.1", "What Is a Website, Really?"),
        section("09.2", "Static Sites, Web Apps, Local Preview, and Published Sites"),
        section("09.3", "Hosting, Domains, DNS, Deployment, and Build Failures"),
        section("09.4", "Build Task: Website Publishing Flow Diagram", "artifact", "35 minutes", "Website publishing flow diagram"),
        section("09.5", "Chapter Checkpoint", "checkpoint", "10 minutes"),
      ]),
      chapter("10", "The Modern Project Stack", "modern-project-stack", "Teachers opening OpenTeachStack, Robotnix, or similar projects need vocabulary for the tools listed in the repo before they can make safe decisions.", "What are the pieces of a modern teacher-owned web project?", "Project stack card", ["stack vocabulary", "web literacy"], [
        section("10.0", "Chapter Overview", "overview", "10 minutes"),
        section("10.1", "What Is a Tech Stack?"),
        section("10.2", "Node.js, npm, pnpm, and Project Commands"),
        section("10.3", "React, Next.js, Vite, TypeScript, Tailwind, Docusaurus, and Nextra"),
        section("10.4", "Build Task: What This Project Uses Stack Card", "artifact", "40 minutes", "Project stack card"),
        section("10.5", "Chapter Checkpoint", "checkpoint", "10 minutes"),
      ]),
      chapter("11", "AI Assistants, Coding Agents, and MCP", "ai-assistants-coding-agents-mcp", "Teachers need to know the difference between chat, autocomplete, repo-aware agents, and MCP-connected tool access before granting project permissions.", "What can AI tools read, edit, run, and connect to?", "AI tool comparison and MCP access map", ["AI agents", "MCP basics"], [
        section("11.0", "Chapter Overview", "overview", "10 minutes"),
        section("11.1", "Chatbot, Assistant, Copilot, or Agent?"),
        section("11.2", "Codex, Claude Code, Gemini CLI, Cursor, and Copilot"),
        section("11.3", "MCP Clients, Servers, Tools, and Trust Boundaries"),
        section("11.4", "Build Task: AI Tool Comparison and MCP Access Map", "artifact", "40 minutes", "AI tool comparison and MCP access map"),
        section("11.5", "Chapter Checkpoint", "checkpoint", "10 minutes"),
      ]),
      chapter("12", "Safety, Backups, Secrets, and Permissions", "safety-backups-secrets-permissions", "A beginner stack is not safe until teachers know how to protect secrets, student data, authored content, and project history.", "How do teachers use AI and software tools without wrecking the repo or exposing private information?", "Safe AI builder checklist", ["safety", "verification"], [
        section("12.0", "Chapter Overview", "overview", "10 minutes"),
        section("12.1", "Backups Before Automation"),
        section("12.2", "Secrets, API Keys, Student Data, and Privacy Boundaries"),
        section("12.3", "Reading Diffs, No-Overwrite Rules, and Draft Folders"),
        section("12.4", "Build Task: Safe AI Builder Checklist", "artifact", "40 minutes", "Safe AI builder checklist"),
        section("12.5", "Chapter Checkpoint", "checkpoint", "10 minutes"),
      ]),
      chapter("13", "Capstone: Teacher Builder Starter Kit", "teacher-builder-starter-kit", "The orientation should end with a small usable kit, not a pile of vocabulary words.", "Can the teacher explain their setup, tools, docs, safety boundaries, and first project workflow?", "Teacher Builder Starter Kit", ["capstone", "setup planning"], [
        section("13.0", "Chapter Overview", "overview", "10 minutes"),
        section("13.1", "Choose Your Builder Setup"),
        section("13.2", "Create Your Tool Inventory and Docs Bookmark Pack"),
        section("13.3", "Write Your First Markdown Lesson"),
        section("13.4", "Final Build: Teacher Builder Starter Kit", "studio", "60 minutes", "Teacher Builder Starter Kit"),
        section("13.5", "Final Reflection", "checkpoint", "10 minutes"),
      ]),
    ],
  },
  {
